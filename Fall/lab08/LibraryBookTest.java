...
public class LibraryBookTest
{
   public static void main( String[] args)
   {
      ...
      bookTwo = new LibraryBook( "Introduction to the Hacking", "Ýsmail Bülbül", 12);
      ...
      // object-reference .equals and == methods examples.
      book1 = new LibraryBook( "Hacking Interface", "x-Master", 0);
      book2 = book1;
      book3 = new LibraryBook( "Kali Linux", "Abdulaziz Altuntaþ", 3);
      book4 = new LibraryBook( "Web and Software Secure", "Furkan Çontar", 0);
